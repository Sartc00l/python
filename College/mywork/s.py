...
class App(toga.App):
    def button_handler(self, widget):
        ...
        self.cur.execute("SELECT password FROM `user` WHERE login=?",(tmp,))
    ...
    def noteShow(self, widget):
        ...
        self.note_win_btn = toga.Button("OK",on_press=self.edit_note,style=self.style)
    ...
    def edit_note(self,widget):
        ...
        sql = "UPDATE note SET note=? WHERE id_user=1 AND id_note=1"
        params = (new_text,)
